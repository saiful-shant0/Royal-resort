...
const Villas = () => {
    return (
        <div className="container pb-5 mt-3" >
            <h2 className="my-4 pt-3">ACCOMADATION</h2>
            <div className="row g-2">
                <div className="col-md-6">
                    <img className="img-fluid" src="https://cdn.sandals.com/sandals/v12/images/general/all-inclusive/accomodations/tranquility-slider/white-room.jpg" alt="" />
                </div>
